   ...
   (M.AutoInit = function (t) {
      var e = t || document.body,
         i = {
            ...
            TABS_OFF_MATERIAL: e.querySelectorAll(
               ".TABS_OFF_MATERIAL:not(.no-autoinit)"
            ),
         ...
         n = (function (n) {
            function s(e, i) {
               ...
               return (
                  ...
                  (n._handleDropdownClickBound =
                     n._handleDropdownClick.bind(n)),
                  (n._handleDropdownKeydownBound =
                     n._handleDropdownKeydown.bind(n)),
                  (n._handleTriggerKeydownBound =
                     n._handleTriggerKeydown.bind(n)),
                  n._setupEventHandlers(),
                  n
               );
            }
                              ...
                              do {
                                 if (
                                    ...
                                    this.dropdownEl.children[o] &&
                                       -1 !==
                                          this.dropdownEl.children[o].tabIndex)
                                 ) {
                                    a = !0;
                                    break;
                                 }
                              ...
                              var h = this.filterQuery.join(""),
                                 d = t(this.dropdownEl)
                                    ...
                                    .filter(function (e) {
                                       return (
                                          0 ===
                                          t(e).text().toLowerCase().indexOf(h)
                                       );
                                    })[0];
                              d &&
      ...
      var i = {
         ...
         n = (function (n) {
            function s(e, i) {
               ...
               return (
                  (n.el.M_TABS_OFF_MATERIAL = n),
                  (n.options = t.extend({}, s.defaults, i)),
                  (n.$tabLinks = n.$el.children("li.tab").children("a")),
                  (n.index = 0),
                  n._setTABS_OFF_MATERIALAndTabWidth(),
                  n._setupActiveTabLink(),
                  n._createIndicator(),
                  n.options.swipeable
                     ? n._setupSwipeableTABS_OFF_MATERIAL()
                     : n._setupNormalTABS_OFF_MATERIAL(),
                  n._setupEventHandlers(),
                  n
               );
            }
               ...
               _createClass(
                  ...
                  [
                        ...
                        value: function () {
                           this._removeEventHandlers(),
                              ...
                              this.options.swipeable
                                 ? this._teardownSwipeableTABS_OFF_MATERIAL()
                                 : this._teardownNormalTABS_OFF_MATERIAL(),
                              (this.$el[0].M_TABS_OFF_MATERIAL = void 0);
                        },
                     },
                     {
                        key: "_setupEventHandlers",
                     ...
                     },
                     {
                        key: "_handleWindowResize",
                        value: function () {
                           this._setTABS_OFF_MATERIALAndTabWidth(),
                              0 !== this.tabWidth &&
                                 0 !== this.TABS_OFF_MATERIALWidth &&
                           ...
                           if (s.length && s.parent().hasClass("tab"))
                              if (n.hasClass("disabled")) e.preventDefault();
                                 ...
                                 (this.index = Math.max(
                                    ...
                                    this.options.swipeable
                                       ? this._TABS_OFF_MATERIALCarousel &&
                                         this._TABS_OFF_MATERIALCarousel.set(
                                            this.index,
                                            function () {
                                               "function" ==
                                                  typeof i.options.onShow &&
                     ...
                     {
                        key: "_setupSwipeableTABS_OFF_MATERIAL",
                        value: function () {
                           var e = this;
                           window.innerWidth >
                           ...
                           var n = t(
                              '<div class="TABS_OFF_MATERIAL-content carousel carousel-slider"></div>'
                           );
                           i.first().before(n),
                              n.append(i),
                              (i[0].style.display = "");
                           var s = this.$activeTabLink.closest(".tab").index();
                           (this._TABS_OFF_MATERIALCarousel = M.Carousel.init(
                              n[0],
                              {
                                 fullWidth: !0,
                                 noWrap: !0,
                              ...
                              this._TABS_OFF_MATERIALCarousel.set(s);
                        },
                     },
                     {
                        key: "_teardownSwipeableTABS_OFF_MATERIAL",
                        value: function () {
                           var t = this._TABS_OFF_MATERIALCarousel.$el;
                           this._TABS_OFF_MATERIALCarousel.destroy(),
                              t.after(t.children()),
                              t.remove();
                        },
                     },
                     {
                        key: "_setupNormalTABS_OFF_MATERIAL",
                        value: function () {
                           this.$tabLinks
                     ...
                     {
                        key: "_teardownNormalTABS_OFF_MATERIAL",
                        value: function () {
                           this.$tabLinks.each(function (e) {
                              if (e.hash) {
                                 var i = t(M.escapeHash(e.hash));
                     ...
                     {
                        key: "_setTABS_OFF_MATERIALAndTabWidth",
                        value: function () {
                           (this.TABS_OFF_MATERIALWidth = this.$el.width()),
                              (this.tabWidth =
                                 Math.max(
                                    this.TABS_OFF_MATERIALWidth,
                                    this.el.scrollWidth
                  ...
                  [
                     ...
                     },
                     {
                        key: "getInstance",
                        value: function (t) {
                           return (t.jquery ? t[0] : t).M_TABS_OFF_MATERIAL;
                        },
                     },
                     {
                        key: "defaults",
                           ...
                           (s._visibleElements = s._visibleElements.filter(
                              ...
                              s._visibleElements[0]
                                 ? (t(
                                   ...
                                   this.id <
                                      s._visibleElements[0][0].M_ScrollSpy.id
                        ...
                        value: function () {
                           ...
                           (s._visibleElements = s._visibleElements.filter(
                              ...
                              s._visibleElements[0] &&
                                 ...
                                 (s._visibleElements =
                                    s._visibleElements.filter(function (t) {
                        ...
                        value: function (t, e, i) {
                           ...
                           for (var g = !1, _ = 0, y = 0; _ < f; _++) {
                              var k = new Date(t, e, _ - r + 1),
                                 ...
                                 L =
                                    s.startRange &&
                                    n._compareDates(s.startRange, k),
                                 T =
                                    s.endRange &&
                     ...
                     },
                     {
                        ...
                        value: function () {
                           ...
                           this.amplitude &&
                              ...
                              (e =
                                 this.amplitude *
                                 Math.exp(-t / this.options.duration)) > 2 ||
                              e < -2
